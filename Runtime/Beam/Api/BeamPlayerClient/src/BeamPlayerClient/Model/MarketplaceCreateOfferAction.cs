...
{
    /// <summary>
    /// MarketplaceCreateOfferAction
    /// </summary>
    [DataContract(Name = "MarketplaceCreateOfferAction")]
    [UnityEngine.Scripting.Preserve]
    public partial class MarketplaceCreateOfferAction
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        public MarketplaceCreateOfferAction(string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string), BaseSignatureRequest signature = default(BaseSignatureRequest), Transaction transaction = default(Transaction))
        {
            ...
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MarketplaceCreateOfferAction and cannot be null");
            }
            this.Id = id;
            this.Index = index;
            this.Type = type;
