...
namespace BeamPlayerClient.Model
{
    ...
    public partial class MarketplaceListAssetAction
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public MarketplaceListAssetAction(string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string), BaseSignatureRequest signature = default(BaseSignatureRequest))
        {
