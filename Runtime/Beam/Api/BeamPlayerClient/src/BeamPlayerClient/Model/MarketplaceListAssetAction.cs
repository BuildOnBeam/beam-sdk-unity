...
{
    /// <summary>
    /// MarketplaceListAssetAction
    /// </summary>
    [DataContract(Name = "MarketplaceListAssetAction")]
    [UnityEngine.Scripting.Preserve]
    public partial class MarketplaceListAssetAction
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplaceListAssetAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected MarketplaceListAssetAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="MarketplaceListAssetAction" /> class.
        /// </summary>
        ...
        [UnityEngine.Scripting.Preserve]
        public MarketplaceListAssetAction(SignatureRequestTypedData signature = default(SignatureRequestTypedData), string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string))
        {
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for MarketplaceListAssetAction and cannot be null");
            }
            this.Signature = signature;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for MarketplaceListAssetAction and cannot be null");
            }
            this.Id = id;
            this.Index = index;
            this.Type = type;
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for MarketplaceListAssetAction and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MarketplaceListAssetAction {\n");
