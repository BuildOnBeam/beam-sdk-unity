...
namespace BeamPlayerClient.Model
{
    ...
    public partial class BuyAssetRequestInput
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public BuyAssetRequestInput(decimal quantity = default(decimal), bool optimistic = false, bool sponsor = true, string policyId = default(string), long chainId = 13337, OperationProcessingEnum? operationProcessing = OperationProcessingEnum.Execute)
        {
