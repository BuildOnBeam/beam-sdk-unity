...
namespace BeamPlayerClient.Model
{
    ...
    public partial class RevokeSessionRequestInput
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public RevokeSessionRequestInput(string address = default(string), bool sponsor = true, string policyId = default(string), long chainId = 13337, OperationProcessingEnum? operationProcessing = OperationProcessingEnum.Execute, AuthProviderEnum? authProvider = AuthProviderEnum.Any)
        {
