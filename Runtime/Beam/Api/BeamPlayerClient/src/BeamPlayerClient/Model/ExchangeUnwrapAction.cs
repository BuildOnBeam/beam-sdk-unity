...
{
    /// <summary>
    /// ExchangeUnwrapAction
    /// </summary>
    [DataContract(Name = "ExchangeUnwrapAction")]
    [UnityEngine.Scripting.Preserve]
    public partial class ExchangeUnwrapAction
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeUnwrapAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        [UnityEngine.Scripting.Preserve]
        protected ExchangeUnwrapAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExchangeUnwrapAction" /> class.
        /// </summary>
        ...
        [UnityEngine.Scripting.Preserve]
        public ExchangeUnwrapAction(string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string), BaseSignatureRequest signature = default(BaseSignatureRequest), ContextExchangeUnwrap context = default(ContextExchangeUnwrap), Transaction transaction = default(Transaction))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for ExchangeUnwrapAction and cannot be null");
            }
            this.Id = id;
            this.Index = index;
            this.Type = type;
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for ExchangeUnwrapAction and cannot be null");
            }
            this.OperationId = operationId;
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for ExchangeUnwrapAction and cannot be null");
            }
            this.Signature = signature;
            // to ensure "context" is required (not null)
            if (context == null)
            {
                throw new ArgumentNullException("context is a required property for ExchangeUnwrapAction and cannot be null");
            }
            this.Context = context;
            // to ensure "transaction" is required (not null)
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction is a required property for ExchangeUnwrapAction and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExchangeUnwrapAction {\n");
