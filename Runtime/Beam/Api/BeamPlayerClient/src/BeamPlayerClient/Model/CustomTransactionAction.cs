...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CustomTransactionAction")]
    [UnityEngine.Scripting.Preserve]
    public partial class CustomTransactionAction
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomTransactionAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomTransactionAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomTransactionAction" /> class.
        /// </summary>
        ...
        [UnityEngine.Scripting.Preserve]
        public CustomTransactionAction(CustomTransactionSignature signature = default(CustomTransactionSignature), CustomTransactionActionTransaction transaction = default(CustomTransactionActionTransaction), string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string))
        {
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for CustomTransactionAction and cannot be null");
            }
            this.Signature = signature;
            // to ensure "transaction" is required (not null)
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction is a required property for CustomTransactionAction and cannot be null");
            }
            this.Transaction = transaction;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for CustomTransactionAction and cannot be null");
            }
            this.Id = id;
            this.Index = index;
            this.Type = type;
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for CustomTransactionAction and cannot be null");
            }
        ...
        [UnityEngine.Scripting.Preserve]
        public CustomTransactionSignature Signature { get; set; }
        ...
        [UnityEngine.Scripting.Preserve]
        public CustomTransactionActionTransaction Transaction { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomTransactionAction {\n");
