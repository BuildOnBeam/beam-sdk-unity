...
namespace BeamPlayerClient.Model
{
    ...
    public partial class CustomTransactionAction
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public CustomTransactionAction(string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string), BaseSignatureRequest signature = default(BaseSignatureRequest), CustomTransactionActionAllOfTransaction transaction = default(CustomTransactionActionAllOfTransaction))
        {
        ...
        [UnityEngine.Scripting.Preserve]
        public CustomTransactionActionAllOfTransaction Transaction { get; set; }
