...
namespace BeamPlayerClient.Model
{
    ...
    public partial class MarketplaceBuyAssetAction
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public MarketplaceBuyAssetAction(string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string), BaseSignatureRequest signature = default(BaseSignatureRequest), Transaction transaction = default(Transaction))
        {
