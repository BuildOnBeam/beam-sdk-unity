...
namespace BeamPlayerClient.Model
{
    ...
    /// SessionRevokeAction
    /// </summary>
    [DataContract(Name = "SessionRevokeAction")]
    [UnityEngine.Scripting.Preserve]
    public partial class SessionRevokeAction
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionRevokeAction" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SessionRevokeAction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SessionRevokeAction" /> class.
        /// </summary>
        ...
        [UnityEngine.Scripting.Preserve]
        public SessionRevokeAction(SignatureRequestMessage signature = default(SignatureRequestMessage), Transaction transaction = default(Transaction), string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string))
        {
            // to ensure "signature" is required (not null)
            if (signature == null)
            {
                throw new ArgumentNullException("signature is a required property for SessionRevokeAction and cannot be null");
            }
            this.Signature = signature;
            // to ensure "transaction" is required (not null)
            if (transaction == null)
            {
                throw new ArgumentNullException("transaction is a required property for SessionRevokeAction and cannot be null");
            }
            this.Transaction = transaction;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for SessionRevokeAction and cannot be null");
            }
            this.Id = id;
            this.Index = index;
            this.Type = type;
            ...
            if (operationId == null)
            {
                throw new ArgumentNullException("operationId is a required property for SessionRevokeAction and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SessionRevokeAction {\n");
