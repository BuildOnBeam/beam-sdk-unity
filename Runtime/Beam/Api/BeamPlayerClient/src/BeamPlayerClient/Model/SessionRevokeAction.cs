...
namespace BeamPlayerClient.Model
{
    ...
    public partial class SessionRevokeAction
    {
        ...
        [UnityEngine.Scripting.Preserve]
        public SessionRevokeAction(string id = default(string), int index = default(int), TypeEnum type = default(TypeEnum), string operationId = default(string), BaseSignatureRequest signature = default(BaseSignatureRequest), Transaction transaction = default(Transaction))
        {
