...
namespace BeamPlayerClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PlayerOperationAction_transaction")]
    [UnityEngine.Scripting.Preserve]
    public partial class PlayerOperationActionTransaction
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        protected PlayerOperationActionTransaction() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerOperationActionTransaction" /> class.
        /// </summary>
        ...
        [UnityEngine.Scripting.Preserve]
        public PlayerOperationActionTransaction(StatusEnum status = default(StatusEnum), string id = default(string), string openfortId = default(string), bool sponsored = default(bool), string actionId = default(string), string hash = default(string))
        {
            this.Status = status;
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new ArgumentNullException("id is a required property for PlayerOperationActionTransaction and cannot be null");
            }
            this.Id = id;
            // to ensure "openfortId" is required (not null)
            if (openfortId == null)
            {
                throw new ArgumentNullException("openfortId is a required property for PlayerOperationActionTransaction and cannot be null");
            }
            ...
            if (actionId == null)
            {
                throw new ArgumentNullException("actionId is a required property for PlayerOperationActionTransaction and cannot be null");
            }
            this.ActionId = actionId;
            // to ensure "hash" is required (not null)
            if (hash == null)
            {
                throw new ArgumentNullException("hash is a required property for PlayerOperationActionTransaction and cannot be null");
            }
            this.Hash = hash;
        }
