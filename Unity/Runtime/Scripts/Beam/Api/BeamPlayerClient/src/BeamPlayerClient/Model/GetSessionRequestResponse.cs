...
namespace BeamPlayerClient.Model
{
    ...
    public partial class GetSessionRequestResponse
    {
        ...
        public GetSessionRequestResponse(StatusEnum status = default(StatusEnum), AuthProviderEnum authProvider = default(AuthProviderEnum), string id = default(string), DateTime createdAt = default(DateTime), DateTime? updatedAt = default(DateTime?), string entityId = default(string), string gameId = default(string), long chainId = default(long), string openfortId = default(string), string address = default(string), List<string> contracts = default(List<string>))
        {
            ...
            if (entityId == null)
            {
                throw new ArgumentNullException("entityId is a required property for GetSessionRequestResponse and cannot be null");
            }
            this.EntityId = entityId;
            // to ensure "gameId" is required (not null)
            if (gameId == null)
            {
                throw new ArgumentNullException("gameId is a required property for GetSessionRequestResponse and cannot be null");
            }
            this.GameId = gameId;
